...
#define TMF8X2X_COM_BUILD_TYPE__build__MASK  0x7
#define TMF8X2X_COM_BUILD_TYPE__build__WIDTH 3
#define TMF8X2X_COM_BUILD_TYPE__build__SHIFT 0
#define TMF8X2X_COM_BUILD_TYPE__build__RESET 0
#define TMF8X2X_COM_BUILD_TYPE__8x8_measurements__MASK  0x8
#define TMF8X2X_COM_BUILD_TYPE__8x8_measurements__WIDTH 1
#define TMF8X2X_COM_BUILD_TYPE__8x8_measurements__SHIFT 3
#define TMF8X2X_COM_BUILD_TYPE__8x8_measurements__RESET 0
#define TMF8X2X_COM_BUILD_TYPE__8x8_measurements 8
#define TMF8X2X_COM_BUILD_TYPE__short_range_accuracy__MASK  0x10
#define TMF8X2X_COM_BUILD_TYPE__short_range_accuracy__WIDTH 1
#define TMF8X2X_COM_BUILD_TYPE__short_range_accuracy__SHIFT 4
#define TMF8X2X_COM_BUILD_TYPE__short_range_accuracy__RESET 1
#define TMF8X2X_COM_BUILD_TYPE__short_range_accuracy 16
...
#define TMF8X2X_COM_MEASURE_STATUS__measure_status__ERR_MEASURE_TDC_LOCKUP 24 // a TDC locked up and cannot be recovere. 
...
#define TMF8X2X_COM_CMD_STAT__cmd_stat__CMD_RESET_FACTORY_CALIBRATION 31 // Manually reset the factory calibration. Only supported if 8x8_measurements = 1.											
...
#define TMF8X2X_COM_CMD_STAT__cmd_stat__CMD_SWITCH_TMF8821_MODE 101 // Switch to 3x3/3x6/4x4 mode. The device will need to be re-configured after this command. Only supported if 8x8_measurements = 1.	
#define TMF8X2X_COM_CMD_STAT__cmd_stat__CMD_SWITCH_TMF8828_MODE 108 // Switch to 8x8 mode. The device will need to be re-configured after this command. Only supported if 8x8_measurements = 1.	
#define TMF8X2X_COM_CMD_STAT__cmd_stat__CMD_SHORT_RANGE 110 // Switch to short range accuracy mode. Do not send this command when a measurement is ongoing. Only supported if short_range_accuracy = 1. 
#define TMF8X2X_COM_CMD_STAT__cmd_stat__CMD_LONG_RANGE 111 // Switch to long range accuracy mode. Do not send this command when a  measurement is ongoing. Only supported if short_range_accuracy = 1.	
...
#define TMF8X2X_COM_TMF8828_MODE 0x10
#define TMF8X2X_COM_TMF8828_MODE__mode__MASK  0xff
#define TMF8X2X_COM_TMF8828_MODE__mode__WIDTH 8
#define TMF8X2X_COM_TMF8828_MODE__mode__SHIFT 0
#define TMF8X2X_COM_TMF8828_MODE__mode__RESET 0
// Enumeration for mode
#define TMF8X2X_COM_TMF8828_MODE__mode__TMF8821 0 // the device is operating in 3x3/3x6/4x4 (TMF8820/TMF8821) mode 		 	
#define TMF8X2X_COM_TMF8828_MODE__mode__TMF8828 8 // the device is operating in 8x8 (TMF8828) mode								


#define TMF8X2X_COM_ACTIVE_RANGE 0x19
#define TMF8X2X_COM_ACTIVE_RANGE__active_range__MASK  0xff
#define TMF8X2X_COM_ACTIVE_RANGE__active_range__WIDTH 8
#define TMF8X2X_COM_ACTIVE_RANGE__active_range__SHIFT 0
#define TMF8X2X_COM_ACTIVE_RANGE__active_range__RESET 111
// Enumeration for active_range
#define TMF8X2X_COM_ACTIVE_RANGE__active_range__NO_ACTIVE_RANGE_SUPPORTED 0 // This device or patch does not support modes for range accuracy. 		 	
#define TMF8X2X_COM_ACTIVE_RANGE__active_range__SHORT_RANGE_ACCURACY 110 // The device is in short range accuracy mode.								
#define TMF8X2X_COM_ACTIVE_RANGE__active_range__LONG_RANGE_ACCURACY 111 // The device is in long range accuracy mode.								


#define TMF8X2X_COM_MEASURE_INFO 0x1a
#define TMF8X2X_COM_MEASURE_INFO__spread_spectrum_reduced__MASK  0x80
#define TMF8X2X_COM_MEASURE_INFO__spread_spectrum_reduced__WIDTH 1
#define TMF8X2X_COM_MEASURE_INFO__spread_spectrum_reduced__SHIFT 7
#define TMF8X2X_COM_MEASURE_INFO__spread_spectrum_reduced__RESET 0
#define TMF8X2X_COM_MEASURE_INFO__spread_spectrum_reduced 128
